  ...
  return (
    <div className="mt-10 lg:mt-16 flex flex-col items-center justify-center ">
      <div className="flex flex-col items-center justify-center">
        ...
        Get ready, web adventurers! Our incredible website templates are coming soon. Subscribe now for a 50% discount on your first three templates. Don&lsquo;t miss out on this epic deal! 🚀💥
        </p>
        {/* <h2 className="text-4xl sm:text-6xl font-bold text-white text-center my-3">
      ...
      <div className="flex flex-col items-center justify-center w-full">
        ...
        <p className="text-gray-400 mt-2">* Don&lsquo;t worry we will not spam you:)</p>
      </div>
    </div>
  );
};
